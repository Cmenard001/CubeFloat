 ...
 * @author	Cécile Lebrun 		&& Luc Hérault --> portage sur g431
 ...
 * 		 	aprés que la mesure ait été effectuée.
 *
 *
...
//Si la pin ADDR n'est pas reliée à la masse mais au 3.3V, changer cette macro en lui donnant la valeur BH1750FVI_ADDR_H
 ...
 * 			automatiquement aprés avoir effectué une mesure.
 ...
 * 			mesurer la luminosité dans l'obscurité. Pour connaétre les autres modes disponibles, voir le fichier bh1750fvi.h.
 */
